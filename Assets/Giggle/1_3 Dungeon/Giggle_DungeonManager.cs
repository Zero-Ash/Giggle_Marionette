...
public class Giggle_DungeonManager : Giggle_SceneManager
{
    ...
    public partial class UI_MainBasicData : UI_BasicData
    {
        ...
        public class ScrollView_Formation : Giggle_UI.ScrollView
        {
            ...
            {
                Basic_list[0].Find("Button").name = "Button/FORMATION/SCROLL_VIEW/0";
                Basic_list[1].Find("Button").name = "Button/FORMATION/SCROLL_VIEW/1";
            }

            protected override void Basic_AddList__SetName(Transform _element)
            {
                _element.Find("Button").name = "Button/FORMATION/SCROLL_VIEW/" + Basic_list.Count;
            }
